...
afamqp_dd_init(LogPipe *s)
{
  ...
  if (!log_threaded_dest_driver_init_method(&self->super,
                                            ...
                                            SCS_AMQP, afamqp_dd_format_stats_instance(self)))
    return FALSE;
...
afamqp_dd_deinit(LogPipe *s)
{
  ...
  return log_threaded_dest_driver_deinit_method(&self->super,
                                                SCS_AMQP,
                                                afamqp_dd_format_stats_instance(self));
}
...
afamqp_dd_new(void)
{
  ...
  self->super.super.super.super.deinit = afamqp_dd_deinit;
  self->super.super.super.super.free_fn = afamqp_dd_free;

  self->super.worker.init = afamqp_worker_thread_init;
